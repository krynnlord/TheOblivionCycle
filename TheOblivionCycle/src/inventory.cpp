...
void trinkets()
{
        ...
        cout << endl;
        cout << "---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---" << endl;
        if (rabbit_foot.have == 1) { trinket_checker(rabbit_foot); } else { ; }
...
void weapons_display()
{
    ...
    cout << endl;
    cout << "---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---" << endl;
    if (hands.have == 1) { weapon_checker(hands);  } else { ; }
    if (dagger.have == 1) { weapon_checker(dagger); } else { ; }
    if (club.have == 1) { weapon_checker(club); } else { ; }
    if (handaxe.have == 1) { weapon_checker(handaxe); } else { ; }
    if (mace.have == 1) { weapon_checker(mace); } else { ; }
    if (shortsword.have == 1) { weapon_checker(shortsword); } else { ; }
    if (lighthammer.have == 1) { weapon_checker(lighthammer); } else { ; }
    if (warhammer.have == 1) { weapon_checker(warhammer); } else { ; }
    if (longsword.have == 1) { weapon_checker(longsword); } else { ; }
    if (greatsword.have == 1) { weapon_checker(greatsword); } else { ; }
    if (maul.have == 1) { weapon_checker(maul); } else { ; }
    cout << endl;
    cout << "---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---" << endl;
    cout << " Press any key to return" << endl;
    cout << "---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---~~~---" << endl;
